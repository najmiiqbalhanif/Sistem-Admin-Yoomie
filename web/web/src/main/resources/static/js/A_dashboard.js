(function () {
    // Guard: jika file ini dieksekusi di Node.js / non-browser, hentikan agar tidak error
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function initPriceMask(hiddenId, displayId) {
            ...
            display.addEventListener('input', () => {
                ...
                if (typeof display.setSelectionRange === 'function') {
        ...
        function showSection(sectionName) {
            ...
            // Update URL without reload, keep other params
